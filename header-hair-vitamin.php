<!DOCTYPE html>
<html data-wf-page="61a644c49f4ce98a8f076678" data-wf-site="61a644c49f4ce955f607666b">
<head>
  <meta charset="utf-8">
  <title>Hair Vitalizing Vitamins</title>
  <meta content="width=device-width, initial-scale=1" name="viewport">
  <title>Long Hair Don't Care - Hair Growth Multivitamin</title>
  <meta content="Long Hair Don't Care" property="og:title">
  <meta content="width=device-width, initial-scale=1" name="viewport">
  <meta name="description" content="Long Hair Don't Care provides hair growth multivitamins to promote longer healthier hair, skin and nails. Packed a daily multivitamin for women packed full of Biotin. Made in the USA at an affordable price. Ban the pink tax, high quality made in America Products at affordable prices">
...
<body <?php body_class("body vsc-initialized"); ?>>
  ...
  <div class="navigation-items">
      ...
      <nav role="navigation" class="navigation-items w-nav-menu" style="transform: translateY(0px) translateX(0px);">
        ...
        <div class="menu-button w-nav-button"><img src="<?php bloginfo("template_directory");?>/images/menu-icon_1menu-icon.png" width="22" alt="" class="menu-icon"></div>
      </div>
    </div>
  </div>
